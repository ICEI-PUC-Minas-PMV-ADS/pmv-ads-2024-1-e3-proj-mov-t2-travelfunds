...
<table>
    ...
    <tr>
    <td width="300" >
        <img width="200"  src="./img/Cadastro.png">
    </td>
        <td width="300" >
...
<table>
    ...
    <tr>
    <td width="300" >
        <img width="200"  src="./img/Configurar Perfil.png">
    </td>
        <td width="300" >
...
<table>
    ...
    <td width="300" >
        ...
        <td width="300" >
            <a href="../src/travelfunds-app/src/components/DashboardPlanejadas.js">Link do Código Fonte</a>
        </td>
    </tr>
</table>
